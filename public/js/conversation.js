...
// Set up the input box to underline text as it is typed
    ...
    textArray.forEach(function(currentText) {
      if (currentText) {
        var messageJson = {
          // <div class='segments'>
          'tagName': 'li',
          'classNames': [(isUser ? 'from-user' : 'from-watson'), 'latest', ((messageArray.length === 0) ? 'top' : 'sub'), 'collection-item', 'animated', 'fadeIn'],
          'children': [{
            // <p>{messageText}</p>
            'tagName': 'span',
            'text': currentText
  ...
  function scrollToChatBottom() {
    ...
    var scrollingChat = document.querySelector(settings.selectors.chatBox);
